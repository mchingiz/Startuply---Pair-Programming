...
//Features
$("#featuresList .container .row:nth-child(odd)").addClass("animateLeft")
$("#featuresList .container .row:nth-child(even)").addClass("animateRight")
...
$(window).scroll(function(){
	...
	if( wScroll > ( $("#featuresList .container").offset().top - wHeight/1.8+300) ){
